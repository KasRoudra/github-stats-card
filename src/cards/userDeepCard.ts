        ...
        <div class="stats">
          ...
          <div class="stats5">
            <div class="lang stat">
              ...
              <div class="lang-count count">${langCount}</div>
            </div>
          ...
          <div xmlns="http://www.w3.org/1999/xhtml" class="body">
            <table>
              ...
              <tr style="animation-delay: 1200ms">
                ...
                <td id="langCount">${langCount}</td>
              </tr>

              <tr style="animation-delay: 1350ms">
                <td>
                  <svg
                    class="octicon"
                    viewBox="0 0 16 16"
